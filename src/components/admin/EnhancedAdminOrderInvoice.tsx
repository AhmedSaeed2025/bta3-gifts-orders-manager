...
interface EnhancedAdminOrderInvoiceProps {
  order: AdminOrder;
  onClose?: () => void;
}

const EnhancedAdminOrderInvoice: React.FC<EnhancedAdminOrderInvoiceProps> = ({ order, onClose }) => {
  ...
  const remainingAmount = order.total_amount - order.deposit;
    ...
    <div className="space-y-4" dir="rtl">
      ...
      <div ref={invoiceRef} className="bg-white text-black p-8" dir="rtl">
            ...
            <div className="text-left">
              <div className="flex items-center gap-4">
                <img 
                  ...
                  alt="شعار هدايا ملوك الهدايا" 
                  className="h-16 w-16 object-contain"
                />
                <div>
                  <h2 className="text-xl font-bold text-gray-800">هدايا ملوك الهدايا</h2>
                  <p className="text-gray-600">في مصر</p>
                  <p className="text-gray-600 text-sm">أجمل الهدايا والذكريات</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="w-64">
            <div className="space-y-2 border-t border-gray-300 pt-4">
              ...
              <div className="flex justify-between font-bold text-lg border-t border-gray-300 pt-2">
                ...
                <span>{formatCurrency(subtotal + order.shipping_cost - order.discount)}</span>
              </div>
              {order.deposit > 0 && (
              ...
              <div className="flex justify-between font-bold text-lg border-t border-gray-300 pt-2 text-red-600">
        ...
        <div className="mt-8 pt-4 border-t border-gray-300 text-center text-gray-600">
          <p>شكراً لتعاملكم معنا - هدايا ملوك الهدايا</p>
...
export default EnhancedAdminOrderInvoice;
