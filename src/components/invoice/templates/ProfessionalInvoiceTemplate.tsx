  ...
  return (
    <div>
      ...
      >
        ...
        {/* Invoice Summary */}
        <div style={{ padding: '12px', borderBottom: '1px solid #e5e7eb' }}>
          <div style={{ width: '100%', maxWidth: '200px', marginRight: 'auto', border: '1px solid #e5e7eb', borderRadius: '8px', overflow: 'hidden' }}>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              <tbody>
                <tr style={{ borderBottom: '1px solid #f3f4f6' }}>
                  <td style={{ padding: '6px 8px', fontSize: '10px', color: '#6b7280' }}>إجمالي المنتجات:</td>
                  <td style={{ padding: '6px 8px', fontSize: '10px', fontWeight: '600', textAlign: 'left' }}>{formatCurrency(subtotal)}</td>
                </tr>
                <tr style={{ borderBottom: '1px solid #f3f4f6' }}>
                  <td style={{ padding: '6px 8px', fontSize: '10px', color: '#6b7280' }}>الشحن:</td>
                  <td style={{ padding: '6px 8px', fontSize: '10px', fontWeight: '600', textAlign: 'left' }}>{formatCurrency(shipping)}</td>
                </tr>
                {discount > 0 && (
                  <tr style={{ borderBottom: '1px solid #f3f4f6' }}>
                    <td style={{ padding: '6px 8px', fontSize: '10px', color: '#6b7280' }}>الخصم:</td>
                ...
                <tr style={{ borderBottom: '1px solid #f3f4f6', backgroundColor: '#dbeafe' }}>
                  <td style={{ padding: '8px', fontSize: '10px' }}>
                    <span style={{ backgroundColor: '#3b82f6', color: '#ffffff', padding: '2px 8px', borderRadius: '4px', fontWeight: 'bold', fontSize: '9px' }}>المجموع:</span>
                  </td>
                  <td style={{ padding: '8px', fontSize: '12px', fontWeight: 'bold', textAlign: 'left' }}>{formatCurrency(total)}</td>
                </tr>
                <tr style={{ borderBottom: '1px solid #f3f4f6' }}>
                  <td style={{ padding: '6px 8px', fontSize: '10px', color: '#6b7280' }}>المدفوع:</td>
                  <td style={{ padding: '6px 8px', fontSize: '10px', fontWeight: '600', textAlign: 'left', color: '#16a34a' }}>{formatCurrency(-paid)}</td>
                </tr>
                <tr style={{ backgroundColor: '#fee2e2' }}>
                  <td style={{ padding: '8px', fontSize: '10px' }}>
                    <span style={{ backgroundColor: '#dc2626', color: '#ffffff', padding: '2px 8px', borderRadius: '4px', fontWeight: 'bold', fontSize: '9px' }}>المتبقي:</span>
                  </td>
