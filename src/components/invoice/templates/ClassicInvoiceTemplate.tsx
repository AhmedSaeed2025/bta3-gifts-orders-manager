    ...
    <div>
      ...
      >
        ...
        {order.notes && (
          <div style={{ marginBottom: '16px', backgroundColor: '#fefce8', borderRight: '4px solid #f59e0b', padding: '10px', borderRadius: '6px' }}>
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '8px' }}>
              ...
              <div>
                <div style={{ fontSize: '10px', fontWeight: 'bold', color: '#92400e', marginBottom: '4px' }}>ملاحظات الطلب:</div>
        ...
        {invoicePolicy.enabled && invoicePolicy.content && (
          <div style={{ padding: '10px 12px', borderTop: '1px dashed #d1d5db' }}>
            <div style={{ fontSize: '10px', fontWeight: 'bold', color: '#2563eb', marginBottom: '4px', textAlign: 'center' }}>📋 {invoicePolicy.title}</div>
